...
describe.skip("Adding documentation tabs", () => {
  // it("renders docs getting started correctly", () => {
  //   const tree = renderer.create(<Docs />).toJSON();
  //   expect(tree).toMatchSnapshot();
  // });
  it("renders styling component correctly", () => {
    const tree = renderer.create(<ComponentStyling />).toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it("renders environment setup correctly", () => {
    const tree = renderer.create(<EnvironmentSetup />).toJSON();
    expect(tree).toMatchSnapshot();
  });
  it("renders hierarchy visualization correctly", () => {
    const tree = renderer.create(<HierarchyVisualization />).toJSON();
    expect(tree).toMatchSnapshot();
  });
